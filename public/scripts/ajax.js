...
function initializeForms2() {

	document.rjournal.journalID.selectedIndex = 1;
	document.rjournal.journalID.selectedIndex = 0;
	fillissue3(getnid(document.rjournal.journalID.value),document.rjournal.volume.value);
...
function initializeForms() {
	...
	document.rjournal.journalID.selectedIndex = 1;
	document.rjournal.journalID.selectedIndex = 0;
	fillissue2(getnid(document.rjournal.journalID.value),document.rjournal.volume.value);
	document.rissue.issueID.selectedIndex = 1;
	document.rissue.issueID.selectedIndex = 0;
...
var url="../../../../../../../../../GetIssues.php?q="+str+"&v="+str2;
...
var url="../../../../../../../../../GetIssues2.php?q="+str+"&v="+str2;
...
var url="../../../../../../../../../GetArticles.php?q="+q+"&j="+j;
...
var url="../../../../../../../../../GetArticles2.php?q="+q+"&j="+j;
...
if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete" )
 { 
  	document.rissue.issueID.innerHTML=xmlHttp.responseText;
	fillarticle2(document.rissue.issueID.value);
} 
