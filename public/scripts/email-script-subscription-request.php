...
if($callfrom == "http://www.benthamscience.com/journal/render-subscription.php" || $callfrom == "http://benthamscience.com/journal/render-subscription.php" || $callfrom == "http://test.benthamscience.com/journal/render-subscription.php")
{
}
else
{
