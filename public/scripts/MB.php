<?php
session_start();
$conn = mysql_connect("benthamscience.com", "bentsci_admin", "W2fwB7L7f5eyAs7j") or die ('Cannot establish connection to the database because: ' . mysql_error());
mysql_select_db ("bentsci_db");

header('Content-type: text/html; charset=utf-8');

$query12="SELECT Abstract_Journal_Code, Abstract_Day, Abstract_Month_ID, Abstract_Month, Abstract_Year, Abstract_Title, Abstract_Authors, Abstract_Author_Aff, Abstract_Text, Abstract_Keywords, Abstract_Sub_Date, Article_Sub_Date, Author_Title, Author_First_Name, Author_Last_Name, Author_Address, Author_City, Author_State, Author_Zip, Author_Country, Author_Email, REMOTE_ADDR, REMOTE_HOST, REMOTE_PORT, REQUEST_TIME, HTTP_REFERER, SCRIPT_FILENAME, IP_TO_COUNTRY FROM `abstract_submissions` WHERE `Abstract_ID` >= 7500 ORDER BY `Abstract_ID` DESC ";
...
//$query12="";
	...
	$result12=mysql_query($query12)or die(mysql_error());
		if (mysql_num_rows($result12))
			{
			for($a =0; $a < mysql_num_rows($result12);$a++)
			  {
				$row12 = mysql_fetch_array($result12);
				$journalname = strtoupper($row12['Abstract_Journal_Code']);
				$abstracttitle = $row12['Abstract_Title']."<br>";
				$authoraff = $row12['Abstract_Author_Aff']."<br>";
				$keywords = $row12['Abstract_Keywords']."<br>";
				$abstracttext = $row12['Abstract_Text']."<br>";
				$submissiondate = $row12['Article_Sub_Date']."<br>";
				$title = $row12['Author_Title']."<br>";
				$firstname = $row12['Author_First_Name']."<br>";
				$lastname = $row12['Author_Last_Name']."<br>";
				$address = $row12['Author_Address']."<br>";
				$useremail = $row12['Author_Email']."<br>";
				$city = $row12['Author_City']."<br>";
				$state = $row12['Author_State']."<br>";
				$zip = $row12['Author_Zip']."<br>";
				$country = $row12['Author_Country']."<br>";
				
				
				$to =  "faisal@benthamscience.net";
				...
				$message = "<table class='MsoNormalTable' border='0' cellspacing='0' cellpadding='0' style='border-collapse: collapse' id='table1' width='1000'>
	<tr>
		<td width='505' valign='top' style='width: 546px; border-left: 1.0pt solid #17365D; border-right: 1.0pt solid #17365D; border-top: 1.0pt solid #17365D; border-bottom: medium none; padding-left: 5.4pt; padding-right: 5.4pt; padding-top: 0in; padding-bottom: 0in; background: #17365D'>
		</td>";
		
	

$message =$message."<tr style='height: 81.0pt'>
		<td valign='top' colspan='3' style='width: 378.9pt; height: 81.0pt; border-left: 1.0pt solid #17365D; border-right: 1.0pt solid #17365D; border-top: medium none; border-bottom: 1.0pt solid #17365D; padding-left: 5.4pt; padding-right: 5.4pt; padding-top: 0in; padding-bottom: 0in; background: white'>
		<p align='left' class='MsoNormal'>
		<span style='font-size: 16.0pt; line-height: 115%; font-family: Verdana, Arial, Helvetica, sans-serif; color: #4F6228'><b><br>
		</b></span></p>
		
		<div align='justify' style='padding:10px;font-size:16px;'>
        	[$subject]<br><br>

 Attention Editorial Office $journalname:<br><br>

 Following Abstract has been submitted by $title $lastname to $journalname..<br><br>

 ========================================================<br><br>

 Abstract Details:<br><br>

 ========================================================<br><br>

 Abstract Title: $abstracttitle <br>

 Contributing Authors:  $authors<br><br>

 Author Affiliation: $authoraff<br><br>

 Abstract Keywords: $keywords<br><br>

 Abstract Description: $abstracttext<br><br>

 Tentative Date of manuscript submission: $submissiondate<br><br>
...
die();*/
				...
				$from = "Email";
				$message = ConvertToEntityNumberVerify($message);
				$cc = 0;
				$bcc = 0;
	
	SendMailVerify($to,$from,$subject,$message,$cc,$bcc);
...
// final Email
		function SendMailVerify($to,$from,$subject,$message,$cc='0',$bcc='0') {
...
function ConvertToEntityNumberVerify($str) {
	...
	// final Email
		function SendMail($to,$from,$subject,$message,$cc='0',$bcc='0') {
	...
	function ConvertToEntityNumber($str) {
