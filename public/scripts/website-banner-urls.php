...
$iptocountry = '';
	...
	$query =  "INSERT INTO websitebannerclicks (BannerName, JournalCode, clickDateDay, clickDateMonthID, clickDateMonth, clickDateYear, URL, REMOTE_ADDR, REMOTE_HOST, REMOTE_PORT, REQUEST_TIME, HTTP_REFERER, SCRIPT_FILENAME, IP_TO_COUNTRY) 
